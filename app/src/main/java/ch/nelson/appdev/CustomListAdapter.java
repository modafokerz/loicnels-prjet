...
public class CustomListAdapter  extends ArrayAdapter<Femme> {
     ...
     * @param objects
     */
    public CustomListAdapter(Context context, int resource, ArrayList<Femme> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            ...
            int defaultImage = mContext.getResources().getIdentifier("@drawable/woman",null,mContext.getPackageName());
